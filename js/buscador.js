...
function renderComics(comics, filteredComics, searchTerm) {
        ...
        <div class="col-md-4 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#comicModal${comic.id}">Ver más</button>
            </div>
          </div>
        </div>
        <!-- Modal -->
        <div class="modal fade" id="comicModal${comic.id}" tabindex="-1" role="dialog" aria-labelledby="comicModalLabel${comic.id}" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="comicModalLabel${comic.id}">${comic.nombre}</h5>
